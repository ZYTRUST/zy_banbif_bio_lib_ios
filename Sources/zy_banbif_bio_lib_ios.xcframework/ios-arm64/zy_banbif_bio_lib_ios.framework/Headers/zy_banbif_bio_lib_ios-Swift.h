...
#ifndef ZY_BANBIF_BIO_LIB_IOS_SWIFT_H
#define ZY_BANBIF_BIO_LIB_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="zy_banbif_bio_lib_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic) BOOL showSteps;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21zy_banbif_bio_lib_ios13ReactResponse")
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_banbif_bio_lib_ios)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_banbif_bio_lib_ios)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_banbif_bio_lib_ios)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(zy_banbif_bio_lib_ios)) <NSURLSessionTaskDelegate>
